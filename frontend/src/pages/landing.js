    ...
    <div class="landing">
      ...
      <section class="hero">
        <div class="hero-content animate-fade-in-up">
          ...
          <p>
            OpenScholar connects generous donors with verified NGOs and scholarship programs,
      ...
      <section class="cta-section">
        <div class="animate-fade-in-up">
          ...
          <p>Join thousands of donors who trust OpenScholar to deliver their generosity to children who need it most.</p>
          <div class="hero-actions">
            <a href="#/donor/browse" class="hero-btn hero-btn-primary">
      ...
      <!-- Footer -->
      <footer class="footer">
        <p>© 2026 OpenScholar. Transparent education funding for a brighter future. 
